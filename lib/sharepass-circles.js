...
const CIRCLE_SEEDS = [
  {
    ...
    members: [
      ...
      createCircleMember({ id: "member-daniel", name: "Daniel", role: "member", mood: "anxiety", color: MEMBER_COLORS[1] }),
  ...
  },
  {
    ...
    members: [
      ...
      createCircleMember({ id: "member-leo", name: "Leo", role: "member", mood: "lonely", color: MEMBER_COLORS[0] }),
  ...
  },
  {
    ...
    members: [
      ...
      createCircleMember({ id: "member-peter", name: "Peter", role: "member", mood: "stress", color: MEMBER_COLORS[2] }),
